...
urlpatterns = [
    ...
    path('delete_home_cms/<int:pk>', views.DeleteHomeCMSView.as_view()),
    ...
    path('delete_footer/<int:pk>', views.delete_footer.as_view()),
    ...
    path('get_static_components_website', views.GetStaticComponents.as_view()),
    path('get_static_components', views.GetStaticComponentsWebsite.as_view()),
